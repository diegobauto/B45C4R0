...
public class Trabajador {
    ...
    public Trabajador(String nombre, String CC, double salarioPorHora, int horasTrabajadas, int diaNacimiento, int mesNacimiento, int yearsNacimiento) {
        ...
        this.yearNacimiento = yearsNacimiento;
    }
    ...
    public String toString() {
        return "Trabajador{" + "nombre=" + nombre + ", CC=" + CC + ", salarioPorHora=" + salarioPorHora + ", horasTrabajadas=" + horasTrabajadas + ", diaNacimiento=" + diaNacimiento + ", mesNacimiento=" + mesNacimiento + ", yearNacimiento=" + yearNacimiento + '}';
    }
